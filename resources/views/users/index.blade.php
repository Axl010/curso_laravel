...
<body class="bg-gray-50">
    ...
    <div class="flex h-screen">
        ...
        <main class="flex-1 overflow-y-auto">
           ...
           <!-- Prácticas con Sessions (placeholder limpio) -->
            <div class="p-6">
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    <h3 class="text-lg font-semibold text-gray-800 mb-4">Prácticas con Sessions</h3>
                    
                    <!-- Mensaje de ejemplo -->
                    <div class="mb-4 px-4 py-3 rounded-lg bg-green-100 text-green-800">
                        Aquí podrás mostrar resultados de tus prácticas.
                    </div>
